...
import { snakeCase } from 'file:///home/eugene/Work/01-work-projects/vpnly-nuxt/node_modules/scule/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///home/eugene/Work/01-work-projects/vpnly-nuxt/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///home/eugene/Work/01-work-projects/vpnly-nuxt/node_modules/ohash/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage, normalizeKey } from 'file:///home/eugene/Work/01-work-projects/vpnly-nuxt/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/eugene/Work/01-work-projects/vpnly-nuxt/node_modules/unstorage/drivers/fs.mjs';
import fsDriver from 'file:///home/eugene/Work/01-work-projects/vpnly-nuxt/node_modules/unstorage/drivers/fs-lite.mjs';
...
import { toRouteMatcher, createRouter } from 'file:///home/eugene/Work/01-work-projects/vpnly-nuxt/node_modules/radix3/dist/index.mjs';
import { toValue } from 'file:///home/eugene/Work/01-work-projects/vpnly-nuxt/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname, resolve as resolve$1, isAbsolute } from 'file:///home/eugene/Work/01-work-projects/vpnly-nuxt/node_modules/pathe/dist/index.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///home/eugene/Work/01-work-projects/vpnly-nuxt/node_modules/ipx/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "885d8978-c9c1-4d5c-a762-209d56ba9429",
    ...
    "routeRules": {
      ...
      "/sitemap_index.xml": {
        "headers": {
          ...
          "X-Sitemap-Prerendered": "2024-07-09T13:05:00.242Z"
        }
      },
      "/index-sitemap.xml": {
        "headers": {
  ...
  "nuxt-site-config": {
    "stack": [
      ...
      },
      {
        ...
        "indexable": false,
        "url": "https://eugenesmolinwork90.github.io"
      },
      {
  ...
  "nuxt-og-image": {
    ...
    "debug": false,
    "baseCacheKey": "/cache/nuxt-og-image@3.0.0-rc.56",
    "fonts": [
      {
        "cacheKey": "Inter:400",
        "style": "normal",
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/home/eugene/Work/01-work-projects/vpnly-nuxt/public"
      ]
    },
    "http": {
      "domains": []
...
const serverAssets = [{"baseName":"nuxt-og-image:fonts","dir":"/home/eugene/Work/01-work-projects/vpnly-nuxt/.nuxt/cache/nuxt-og-image@3.0.0-rc.56/_fonts"},{"baseName":"server","dir":"/home/eugene/Work/01-work-projects/vpnly-nuxt/server/assets"}];
...
const _47home_47eugene_47Work_4701_45work_45projects_47vpnly_45nuxt_47node_modules_47nuxt_47dist_47core_47runtime_47nitro_47cache_45driver_46js = defineDriver((opts) => {
...
storage.mount('internal:nuxt:prerender', _47home_47eugene_47Work_4701_45work_45projects_47vpnly_45nuxt_47node_modules_47nuxt_47dist_47core_47runtime_47nitro_47cache_45driver_46js({"driver":"/home/eugene/Work/01-work-projects/vpnly-nuxt/node_modules/nuxt/dist/core/runtime/nitro/cache-driver.js","base":"/home/eugene/Work/01-work-projects/vpnly-nuxt/.nuxt/cache/nitro/prerender"}));
storage.mount('data', fsDriver({"driver":"fsLite","base":"/home/eugene/Work/01-work-projects/vpnly-nuxt/.data/kv"}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/eugene/Work/01-work-projects/vpnly-nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/eugene/Work/01-work-projects/vpnly-nuxt/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/eugene/Work/01-work-projects/vpnly-nuxt/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/eugene/Work/01-work-projects/vpnly-nuxt/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _SmJ8wRG49s = defineNitroPlugin(async (nitroApp) => {
...
const _uvgJIQ0wEU = defineNitroPlugin(async (nitroApp) => {
...
const _jn0VPZK2qn = defineNitroPlugin(async (nitro) => {
...
const assets = {
  "/200.html": {
    ...
    "etag": "\"35c3-O6jh0Y5eBXp6HrTxiIgfOoCmOT0\"",
    "mtime": "2024-07-09T13:05:13.469Z",
    "size": 13763,
  ...
  "/robots.txt": {
    ...
    "etag": "\"62-3b2j5fJgSpbOxdB+pEljZ6rGXwI\"",
    "mtime": "2024-07-09T13:05:13.449Z",
    "size": 98,
    "path": "../../.output/public/robots.txt"
  },
  "/__sitemap__/style.xsl": {
    "type": "application/xml",
    "etag": "\"174b-skG/rnIkOvOnIyekxXGvr22nLtE\"",
    "mtime": "2024-07-09T13:05:13.449Z",
    "size": 5963,
...
const _44elcp = defineEventHandler(async (e) => {
...
const _xEgOn1 = defineEventHandler(async (e) => {
...
const _YuOCXF = defineEventHandler(async (e) => {
...
const _K9jcxc = defineEventHandler(async (e) => {
...
const _kl2SE8 = defineEventHandler(async (e) => {
  const path = parseURL(e.path).pathname;
...
const _UfDCKt = defineEventHandler(async (e) => {
...
const _VXIShO = defineEventHandler(async (e) => {
  const runtimeConfig = useSimpleSitemapRuntimeConfig();
  const { sitemaps } = runtimeConfig;
...
const _1IuxxB = lazyEventHandler(() => {
...
const _lazy_AhQSlP = () => import('./routes/__og-image__/font/font.mjs');
const _lazy_Fo7d6R = () => import('./routes/__og-image__/image/image.mjs');
const _lazy_HGdiiK = () => import('./_/renderer3.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '', handler: _f4b49z, lazy: false, middleware: true, method: undefined },
  { route: '', handler: _44elcp, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _xEgOn1, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _YuOCXF, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap_index.xml', handler: _K9jcxc, lazy: false, middleware: false, method: undefined },
  { route: '/en-sitemap.xml', handler: _kl2SE8, lazy: false, middleware: false, method: undefined },
  { route: '/ru-sitemap.xml', handler: _kl2SE8, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _UfDCKt, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _VXIShO, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_AhQSlP, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_Fo7d6R, lazy: true, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _1IuxxB, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_HGdiiK, lazy: true, middleware: false, method: undefined }
];
...
export { useStorage as a, useNitroApp as b, useRuntimeConfig as c, joinURL as d, withoutTrailingSlash as e, fetchIsland as f, getRouteRules as g, withBase as h, useNitroOrigin as i, joinRelativeURL as j, decodeHtml as k, htmlDecodeQuotes as l, withQuery as m, normaliseFontInput as n, localFetch as o, parseURL as p, closePrerenderer as q, resolveContext as r, toBase64Image as t, useOgImageRuntimeConfig as u, withTrailingSlash as w };
