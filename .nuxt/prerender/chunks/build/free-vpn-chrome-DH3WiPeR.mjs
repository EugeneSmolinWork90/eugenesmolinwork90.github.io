...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "free-vpn-chrome",
  __ssrInlineRender: true,
  setup(__props) {
    const { t } = useI18n();
    useHead({
      title: t("extension-chrome.seo.title"),
      meta: [
        { name: "description", content: t("extension-chrome.seo.description") }
      ]
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtImg = __nuxt_component_1;
      _push(`<!--[-->`);
      _push(ssrRenderComponent(FirstContentfulPaint, { "keypath-title": "extension-chrome.fcp.title" }, {
        img: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_NuxtImg, {
              src: "/images/pages/extension/chrome.png",
              alt: "Chrome",
              width: "530",
              height: "505"
        ...
        text: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p${_scopeId}>${ssrInterpolate(_ctx.$t("extension-chrome.fcp.text-1"))}</p><p${_scopeId}>${ssrInterpolate(_ctx.$t("extension-chrome.fcp.text-2"))}</p>`);
          } else {
            return [
              createVNode("p", null, toDisplayString(_ctx.$t("extension-chrome.fcp.text-1")), 1),
              createVNode("p", null, toDisplayString(_ctx.$t("extension-chrome.fcp.text-2")), 1)
            ];
          }
        }),
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VButton, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(_ctx.$t("extension-chrome.fcp.button"))}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(_ctx.$t("extension-chrome.fcp.button")), 1)
                  ];
                }
              }),
              _: 1
        ...
        platforms: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(PlatformsList, { "keypath-title": "extension-chrome.fcp.devices.title" }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(PlatformsList, { "keypath-title": "extension-chrome.fcp.devices.title" })
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(HowToSetUp, null, {
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("extension-chrome.how-to-set-up.title"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.$t("extension-chrome.how-to-set-up.title")), 1)
            ];
          }
        }),
        text: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("extension-chrome.how-to-set-up.text"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.$t("extension-chrome.how-to-set-up.text")), 1)
            ];
          }
        }),
          ...
          if (_push2) {
            ...
            ssrRenderList(unref(setUpCards), (card, key) => {
              _push2(ssrRenderComponent(SetUpCard, {
                ...
                title: _ctx.$t(`extension-chrome.how-to-set-up.cards[${key}].title`),
                text: _ctx.$t(`extension-chrome.how-to-set-up.cards[${key}].text`)
              }, null, _parent2, _scopeId));
            });
            _push2(`<!--]-->`);
          } else {
      ...
      _push(ssrRenderComponent(ConnectAndPrivate, { "keypath-title": "extension-chrome.connect-and-private.title" }, {
        cards: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            ssrRenderList(unref(connectCards), (card, key) => {
              _push2(ssrRenderComponent(ConnectAndPrivateCard, {
                key: card.imgType,
                "img-type": card.imgType,
                text: _ctx.$t(`extension-chrome.connect-and-private.cards[${key}]`)
              }, null, _parent2, _scopeId));
            });
            _push2(`<!--]-->`);
          } else {
        ...
        button: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(VButton, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(_ctx.$t("extension-chrome.connect-and-private.button"))}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(_ctx.$t("extension-chrome.connect-and-private.button")), 1)
                  ];
                }
              }),
              _: 1
      ...
      _push(ssrRenderComponent(BenefitsOfServers, null, {
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("extension-chrome.benefits.title"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.$t("extension-chrome.benefits.title")), 1)
            ];
          }
        }),
        cards: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(unref(benefitsCards), (card, key) => {
              _push2(ssrRenderComponent(BenefitsOfServersCard, {
                key: card.imgType,
                "img-type": card.imgType,
                title: _ctx.$t(`extension-chrome.benefits.cards[${key}].title`),
                text: _ctx.$t(`extension-chrome.benefits.cards[${key}].text`)
              }, null, _parent2, _scopeId));
            });
            _push2(`<!--]-->`);
          } else {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/free-vpn-chrome.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=free-vpn-chrome-DH3WiPeR.mjs.map
