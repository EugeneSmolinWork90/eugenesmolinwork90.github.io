...
import { useSSRContext, defineComponent, withCtx, createVNode, toDisplayString, createTextVNode, unref, openBlock, createBlock, Fragment, renderList } from 'file:///home/eugene/Work/01-work-projects/vpnly-nuxt/node_modules/vue/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "free-vpn-windows",
  __ssrInlineRender: true,
  setup(__props) {
    const { t } = useI18n();
    useHead({
      title: t("desktop-windows.seo.title"),
      meta: [
        { name: "description", content: t("desktop-windows.seo.description") }
      ]
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(FirstContentfulPaint, {
        "keypath-title": "desktop-windows.fcp.title",
        class: "fcp-parent"
      }, {
        img: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="fcp-parent__img" data-v-84e95824${_scopeId}>`);
            _push2(ssrRenderComponent(_component_NuxtImg, {
              src: "/images/pages/desktop/windows.png",
              alt: "Windows",
              width: "613",
              height: "591"
        ...
        text: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-84e95824${_scopeId}>${ssrInterpolate(_ctx.$t("desktop-windows.fcp.text-1"))}</p><p data-v-84e95824${_scopeId}>${ssrInterpolate(_ctx.$t("desktop-windows.fcp.text-2"))}</p>`);
          } else {
            return [
              createVNode("p", null, toDisplayString(_ctx.$t("desktop-windows.fcp.text-1")), 1),
              createVNode("p", null, toDisplayString(_ctx.$t("desktop-windows.fcp.text-2")), 1)
            ];
          }
        }),
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VButton, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(_ctx.$t("desktop-windows.fcp.button"))}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(_ctx.$t("desktop-windows.fcp.button")), 1)
                  ];
                }
              }),
              _: 1
      ...
      _push(ssrRenderComponent(HowToSetUp, null, {
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("desktop-windows.how-to-set-up.title"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.$t("desktop-windows.how-to-set-up.title")), 1)
            ];
          }
        }),
        text: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("desktop-windows.how-to-set-up.text"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.$t("desktop-windows.how-to-set-up.text")), 1)
            ];
          }
        }),
          ...
          if (_push2) {
            ...
            ssrRenderList(unref(setUpCards), (card, key) => {
              _push2(ssrRenderComponent(SetUpCard, {
                ...
                title: _ctx.$t(`desktop-windows.how-to-set-up.cards[${key}].title`),
                text: _ctx.$t(`desktop-windows.how-to-set-up.cards[${key}].text`)
              }, null, _parent2, _scopeId));
            });
            _push2(`<!--]-->`);
          } else {
      ...
      _push(ssrRenderComponent(ConnectAndPrivate, { "keypath-title": "desktop-windows.connect-and-private.title" }, {
        cards: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            ssrRenderList(unref(connectCards), (card, key) => {
              _push2(ssrRenderComponent(ConnectAndPrivateCard, {
                key: card.imgType,
                "img-type": card.imgType,
                text: _ctx.$t(`desktop-windows.connect-and-private.cards[${key}]`)
              }, null, _parent2, _scopeId));
            });
            _push2(`<!--]-->`);
          } else {
        ...
        button: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(VButton, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(_ctx.$t("desktop-windows.connect-and-private.button"))}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(_ctx.$t("desktop-windows.connect-and-private.button")), 1)
                  ];
                }
              }),
              _: 1
      ...
      _push(ssrRenderComponent(_component_Section, { class: "platforms-section" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(PlatformsList, { "keypath-title": "desktop-windows.platforms.title" }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(PlatformsList, { "keypath-title": "desktop-windows.platforms.title" })
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(BenefitsOfServers, null, {
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("desktop-windows.benefits.title"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.$t("desktop-windows.benefits.title")), 1)
            ];
          }
        }),
        cards: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(unref(benefitsCards), (card, key) => {
              _push2(ssrRenderComponent(BenefitsOfServersCard, {
                key: card.imgType,
                "img-type": card.imgType,
                title: _ctx.$t(`desktop-windows.benefits.cards[${key}].title`),
                text: _ctx.$t(`desktop-windows.benefits.cards[${key}].text`)
              }, null, _parent2, _scopeId));
            });
            _push2(`<!--]-->`);
          } else {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/free-vpn-windows.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const freeVpnWindows = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-84e95824"]]);

export { freeVpnWindows as default };
//# sourceMappingURL=free-vpn-windows-Ci2MFaAY.mjs.map
