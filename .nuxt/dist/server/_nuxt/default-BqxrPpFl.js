import { _ as _export_sfc, r as defineStore, f as useI18n, s as useLocaleHead, t as __nuxt_component_0$1 } from "../server.mjs";
import { isRef, ref, unref, getCurrentScope, onScopeDispose, toRef as toRef$1, readonly, customRef, watch, computed, defineComponent, mergeProps, withCtx, createVNode, toDisplayString, useSSRContext, openBlock, createBlock, createTextVNode, Fragment, renderList } from "vue";
import { ssrRenderComponent, ssrInterpolate, ssrRenderAttrs, ssrRenderSlot, ssrRenderAttr, ssrRenderClass, ssrRenderList, ssrGetDirectiveProps } from "vue/server-renderer";
import { useHead } from "unhead";
import { P as ProductsEnum, _ as __nuxt_component_0, R as RoutesPathsEnum } from "./routes-Bkc00j1Z.js";
import { _ as __nuxt_component_1, V as VButton } from "./VButton-7LOx4zCV.js";
import Container from "./Container-DL_4idYO.js";
import { P as PLATFORM_LINKS, D as DOWNLOAD_LINKS } from "./links-9sdGeB_B.js";
      ...
      _push(ssrRenderComponent(Container, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<!--]--></div><p class="footer__address" data-v-15e76e92${_scopeId}>${ssrInterpolate(_ctx.$t("footer.address"))}</p><p class="footer__copy" data-v-15e76e92${_scopeId}> © ${ssrInterpolate(unref(fullYear))} VPNLY. ${ssrInterpolate(_ctx.$t("footer.copyright"))}</p>`);
          } else {
            return [
              ...
              createVNode("p", { class: "footer__copy" }, " © " + toDisplayString(unref(fullYear)) + " VPNLY. " + toDisplayString(_ctx.$t("footer.copyright")), 1)
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=default-BqxrPpFl.js.map
